...
test("high-priority quota recovery may use alternate capacity below reserve", () => {
  ...
  assert.equal(chooseProvider({ preferred: "anthropic", quota, urgent: true }), "openai");
});
...
test("all present and future Claude/Codex agents are routable without an allowlist", () => {
  assert.deepEqual(
    routableAgents([
